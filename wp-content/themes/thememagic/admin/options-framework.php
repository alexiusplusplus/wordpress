...
function optionsframework_page() {
	...
	?>
	 ...
	 <div id="go_pro">
            ...
            <p>This is a free version of thememagic. Get your own copy of professional version and get UNLIMITED SLIDER , FULL WIDTH template, No Credit Link, FORUM support and much more. <a href="http://www.themeszen.com/thememagic" target="blank">Click Here to Learn More Now</a> </p>
    ...
    <div id="optionsframework" class="postbox">
        ...
        <div id="optionsframework-submit">
            ...
            <input type="submit" class="reset-button button-secondary" name="reset" value="<?php esc_attr_e( 'Restore Defaults' ); ?>" onclick="return confirm( '<?php print esc_js( __( 'Click OK to reset. Any theme settings will be lost!' , 'thememagic' ) ); ?>' );" />
            <div class="clear"></div>
		</div>
	</form>
</div> <!-- / #container -->
...
function optionsframework_adminbar() {
	...
	$wp_admin_bar->add_menu( array(
		'parent' => 'appearance',
		'id' => 'of_theme_options',
		'title' => __( 'Theme Options' , 'thememagic' ),
