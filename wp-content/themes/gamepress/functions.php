...
add_shortcode('wp_caption', 'gamepress_fixed_img_caption_shortcode');
add_shortcode('caption', 'gamepress_fixed_img_caption_shortcode');
function gamepress_fixed_img_caption_shortcode($attr, $content = null) {
...
include(get_template_directory() . "/admin/widgets/twitter-widget.php");
